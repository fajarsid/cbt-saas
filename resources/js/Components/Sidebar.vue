<template>
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white" data-simplebar
        style="position: fixed; z-index: 1030;">


        <div class="sidebar-inner px-4 pt-3 pb-5">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/tenants') }">
                    <Link href="/admin/tenants" class="nav-link d-flex justify-content-between">
                        <span>
                            <span class="sidebar-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                    class="bi bi-building icon icon-xs me-2" viewBox="0 0 16 16">
                                    <path
