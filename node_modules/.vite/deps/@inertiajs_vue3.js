    ...
    var merge4 = function merge5(target, source, options) {
      ...
      return Object.keys(source).reduce(function(acc, key2) {
        ...
        if (has2.call(acc, key2)) {
          acc[key2] = merge5(acc[key2], value, options);
        } else {
          acc[key2] = value;
        }
        return acc;
  ...
  "node_modules/qs/lib/parse.js"(exports2, module2) {
    ...
    var parseValues = function parseQueryStringValues(str, options) {
      ...
      for (i = 0; i < parts.length; ++i) {
        ...
        var val;
        if (pos === -1) {
          key2 = options.decoder(part, defaults4.decoder, charset, "key");
          val = options.strictNullHandling ? null : "";
        } else {
          key2 = options.decoder(part.slice(0, pos), defaults4.decoder, charset, "key");
          if (key2 !== null) {
            val = utils.maybeMap(
              parseArrayValue(
                part.slice(pos + 1),
                options,
                isArray4(obj[key2]) ? obj[key2].length : 0
              ),
              function(encodedVal) {
...
function create(prototype5, properties) {
  var result2 = baseCreate_default(prototype5);
...
function baseUnset(object, path) {
  ...
  while (++index < length) {
    ...
    if (key2 === "__proto__" && !hasOwnProperty23.call(object, "__proto__")) {
      return false;
    }
    if (key2 === "constructor" && index + 1 < length && typeof path[index + 1] === "string" && path[index + 1] === "prototype") {
...
function customDefaultsAssignIn(objValue, srcValue, key2, object) {
  if (objValue === void 0 || eq_default(objValue, objectProto28[key2]) && !hasOwnProperty24.call(object, key2)) {
    return srcValue;
  }
  return objValue;
}
...
function merge2() {
  ...
  const assignValue2 = (val, key2) => {
    const targetKey = caseless && findKey2(result2, key2) || key2;
...
function AxiosError(message, code, config3, request2, response) {
  Error.call(this);
...
AxiosError.from = (error, code, config3, request2, response, customProps) => {
  ...
  AxiosError.call(axiosError, msg, errCode, config3, request2, response);
...
function CanceledError(message, config3, request2) {
  AxiosError_default.call(this, message == null ? "canceled" : message, AxiosError_default.ERR_CANCELED, config3, request2);
  ...
  return async (config3) => {
    ...
    try {
      ...
      if (err && err.name === "TypeError" && /Load failed|fetch/i.test(err.message)) {
        throw Object.assign(
          new AxiosError_default("Network Error", AxiosError_default.ERR_NETWORK, config3, request2),
          {
            cause: err.cause || err
          }
        );
      }
      throw AxiosError_default.from(err, err && err.code, config3, request2);
    }
  };
};
...
function objectToFormData(source, form = new FormData(), parentKey = null, queryStringArrayFormat = "brackets") {
  ...
  for (const key2 in source) {
    if (Object.prototype.hasOwnProperty.call(source, key2)) {
      append2(form, composeKey(parentKey, key2, "indices"), source[key2], queryStringArrayFormat);
    }
  }
  return form;
}
...
function append2(form, key2, value, format) {
  if (Array.isArray(value)) {
    return Array.from(value.keys()).forEach(
      (index) => append2(form, composeKey(key2, index.toString(), format), value[index], format)
    );
...
var CurrentPage = class {
  ...
  set(page22, {
    ...
    return this.resolve(page22.component).then((component2) => {
      ...
      const pageForHistory = { ...page22, flash: {} };
      return new Promise(
  ...
  mergeOncePropsIntoResponse(response, { force = false } = {}) {
    Object.entries(response.onceProps ?? {}).forEach(([key2, onceProp]) => {
      var _a;
      const existingOnceProp = (_a = this.page.onceProps) == null ? void 0 : _a[key2];
...
var History = class {
  ...
  restore(key2) {
    var _a, _b, _c, _d;
    if (!isServer) {
      return ((_a = this.current[this.rememberedState]) == null ? void 0 : _a[key2]) !== void 0 ? (_b = this.current[this.rememberedState]) == null ? void 0 : _b[key2] : (_d = (_c = this.initialState) == null ? void 0 : _c[this.rememberedState]) == null ? void 0 : _d[key2];
    }
  }
  pushState(page22, cb = null) {
    ...
    queue.add(() => {
      return this.getPageData(page22).then((data) => {
        const doPush = () => this.doPushState({ page: data }, page22.url).then(() => cb == null ? void 0 : cb());
        if (isChromeIOS) {
          return new Promise((resolve) => {
  ...
  decrypt(page22 = null) {
    ...
    const pageData = page22 ?? ((_a = window.history.state) == null ? void 0 : _a.page);
  ...
  replaceState(page22, cb = null) {
    ...
    queue.add(() => {
      return this.getPageData(page22).then((data) => {
        const doReplace = () => this.doReplaceState({ page: data }, page22.url).then(() => cb == null ? void 0 : cb());
        if (isChromeIOS) {
          return new Promise((resolve) => {
  ...
  browserHasHistoryEntry() {
    var _a;
    return !isServer && !!((_a = window.history.state) == null ? void 0 : _a.page);
  }
  clear() {
...
var Request = class _Request {
  ...
  getHeaders() {
    ...
    const onceProps = Object.entries(page22.onceProps || {}).filter(([, onceProp]) => {
      if (page22.props[onceProp.prop] === void 0) {
        return false;
      }
...
var RequestStream = class {
  ...
  cancel({ cancelled = false, interrupted = false } = {}, force) {
    ...
    request2 == null ? void 0 : request2.cancel({ interrupted, cancelled });
  }
  shouldCancel(force) {
    if (force) {
      return true;
...
function merge3() {
  ...
  const result2 = {};
  const assignValue2 = (val, key2) => {
    const targetKey = caseless && findKey3(result2, key2) || key2;
...
var reduceDescriptors2 = (obj, reducer) => {
  const descriptors3 = Object.getOwnPropertyDescriptors(obj);
  const reducedDescriptors = {};
  forEach3(descriptors3, (descriptor, name) => {
    let ret;
    if ((ret = reducer(descriptor, name, obj)) !== false) {
      reducedDescriptors[name] = ret || descriptor;
    }
...
var _setImmediate2 = ((setImmediateSupported, postMessageSupported) => {
  ...
  typeof setImmediate === "function",
  isFunction4(_global2.postMessage)
);
...
function AxiosError3(message, code, config3, request2, response) {
  Error.call(this);
  if (Error.captureStackTrace) {
    Error.captureStackTrace(this, this.constructor);
  } else {
...
AxiosError3.from = (error, code, config3, request2, response, customProps) => {
  ...
  const msg = error && error.message ? error.message : "Error";
  const errCode = code == null && error ? error.code : code;
  AxiosError3.call(axiosError, msg, errCode, config3, request2, response);
  if (error && axiosError.cause == null) {
    Object.defineProperty(axiosError, "cause", { value: error, configurable: true });
  }
  axiosError.name = error && error.name || "Error";
...
prototype4.append = function append3(name, value) {
  this._pairs.push([name, value]);
};
prototype4.toString = function toString5(encoder) {
  const _encode = encoder ? function(value) {
...
var InterceptorManager2 = class {
   ...
   */
  forEach(fn) {
    utils_default2.forEach(this.handlers, function forEachHandler(h2) {
      if (h2 !== null) {
        fn(h2);
      }
    });
  ...
  set(header, valueOrRewrite, rewrite) {
    ...
    if (utils_default2.isPlainObject(header) || header instanceof this.constructor) {
      ...
      for (const entry of header) {
        ...
        obj[key2 = entry[0]] = (dest = obj[key2]) ? utils_default2.isArray(dest) ? [...dest, entry[1]] : [dest, entry[1]] : entry[1];
      }
      setHeaders(obj, valueOrRewrite);
    } else {
      header != null && setHeader(valueOrRewrite, header, rewrite);
...
function CanceledError3(message, config3, request2) {
  AxiosError_default2.call(this, message == null ? "canceled" : message, AxiosError_default2.ERR_CANCELED, config3, request2);
  this.name = "CanceledError";
}
...
function mergeConfig3(config1, config22) {
  ...
  utils_default2.forEach(Object.keys({ ...config1, ...config22 }), function computeConfigValue(prop) {
    const merge4 = mergeMap[prop] || mergeDeepProperties;
    const configValue = merge4(config1[prop], config22[prop], prop);
...
var factory2 = (env) => {
  ...
  return async (config3) => {
    ...
    try {
      ...
      if (err && err.name === "TypeError" && /Load failed|fetch/i.test(err.message)) {
        throw Object.assign(
          new AxiosError_default2("Network Error", AxiosError_default2.ERR_NETWORK, config3, request2),
          {
            cause: err.cause || err
          }
        );
      }
      throw AxiosError_default2.from(err, err && err.code, config3, request2);
    }
  };
};
...
var toSimpleValidationErrors = (errors) => {
  return Object.keys(errors).reduce((carry, key2) => ({
    ...carry,
    [key2]: Array.isArray(errors[key2]) ? errors[key2][0] : errors[key2]
  }), {});
};
var toValidationErrors = (errors) => {
  return Object.keys(errors).reduce((carry, key2) => ({
    ...carry,
    [key2]: typeof errors[key2] === "string" ? [errors[key2]] : errors[key2]
  }), {});
};
...
function useForm(...args) {
  ...
  let defaults4 = typeof data === "function" ? cloneDeep_default(data()) : cloneDeep_default(data);
  ...
  const form = reactive({
    ...restored ? restored.data : cloneDeep_default(defaults4),
    isDirty: false,
    ...
    withPrecognition(...args2) {
      ...
      const validator = createValidator((client2) => {
        const { method: method2, url } = precognitionEndpoint();
        const transformedData = cloneDeep_default(transform2(this.data()));
      ...
      Object.assign(formWithPrecognition, {
        ...
        validating: false,
        validator: () => validator,
        withAllErrors: () => tap2(formWithPrecognition, () => withAllErrors = true),
        valid: (field) => formWithPrecognition.__valid.includes(field),
        invalid: (field) => field in this.errors,
        setValidationTimeout: (duration) => tap2(formWithPrecognition, () => validator.setTimeout(duration)),
        validateFiles: () => tap2(formWithPrecognition, () => validator.validateFiles()),
        withoutFileValidation: () => tap2(formWithPrecognition, () => validator.withoutFileValidation()),
        touch: (field, ...fields) => {
        ...
        validate: (field, config22) => {
          if (typeof field === "object" && !("target" in field)) {
            config22 = field;
            field = void 0;
          }
          if (field === void 0) {
            validator.validate(config22);
          } else {
            const fieldName = resolveName(field);
            const transformedData = transform2(this.data());
            validator.validate(fieldName, get_default(transformedData, fieldName), config22);
          }
          return formWithPrecognition;
        },
        setErrors: (errors) => tap2(formWithPrecognition, () => this.setError(errors)),
    ...
    data() {
      return Object.keys(defaults4).reduce((carry, key2) => {
    ...
    defaults(fieldOrFields, maybeValue) {
      ...
      if (typeof fieldOrFields === "undefined") {
        defaults4 = cloneDeep_default(this.data());
        this.isDirty = false;
      } else {
        defaults4 = typeof fieldOrFields === "string" ? set_default(cloneDeep_default(defaults4), fieldOrFields, maybeValue) : Object.assign({}, cloneDeep_default(defaults4), fieldOrFields);
      }
      validatorRef == null ? void 0 : validatorRef.defaults(defaults4);
      return this;
    },
    reset(...fields) {
      const resolvedData = typeof data === "function" ? cloneDeep_default(data()) : cloneDeep_default(defaults4);
      const clonedData = cloneDeep_default(resolvedData);
      if (fields.length === 0) {
        defaults4 = clonedData;
        Object.assign(this, resolvedData);
      } else {
        ;
        fields.filter((key2) => has_default(clonedData, key2)).forEach((key2) => {
          set_default(defaults4, key2, get_default(clonedData, key2));
    ...
    submit(...args2) {
      const { method: method2, url, options } = UseFormUtils.parseSubmitArguments(args2, precognitionEndpoint);
  ...
  watch(
    typedForm,
    (newValue) => {
      typedForm.isDirty = !isEqual_default(typedForm.data(), defaults4);
      if (rememberKey) {
...
var App = defineComponent({
  ...
  setup({ initialPage, initialComponent, resolveComponent, titleCallback, onHeadUpdate }) {
    ...
    page2.value = { ...initialPage, flash: initialPage.flash ?? {} };
    key.value = void 0;
    const isServer2 = typeof window === "undefined";
...
function usePage() {
  return reactive({
    props: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.props;
    }),
    url: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.url;
    }),
    component: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.component;
    }),
    version: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.version;
    }),
    clearHistory: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.clearHistory;
    }),
    deferredProps: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.deferredProps;
    }),
    mergeProps: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.mergeProps;
    }),
    prependProps: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.prependProps;
    }),
    deepMergeProps: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.deepMergeProps;
    }),
    matchPropsOn: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.matchPropsOn;
    }),
    rememberedState: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.rememberedState;
    }),
    encryptHistory: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.encryptHistory;
    }),
    flash: computed(() => {
      var _a;
      return (_a = page2.value) == null ? void 0 : _a.flash;
    })
  });
}
...
var deferred_default = defineComponent({
  ...
  render() {
    ...
    return keys2.every((key2) => this.$page.props[key2] !== void 0) ? (_b = (_a = this.$slots).default) == null ? void 0 : _b.call(_a) : this.$slots.fallback();
  }
});
var noop4 = () => void 0;
var Form = defineComponent({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    const submit = (submitter) => {
      ...
      form.transform(() => props.transform(data)).submit(method2.value, url, submitOptions);
    ...
    const exposed = {
      ...
      validate: (field, config22) => form.validate(...UseFormUtils.mergeHeadersForValidation(field, config22, props.headers)),
...
function usePrefetch(options = {}) {
  ...
  lastUpdatedAt.value = (cached == null ? void 0 : cached.staleTimestamp) || null;
...
var whenVisible_default = defineComponent({
  ...
  created() {
    ...
    this.$watch(
      () => this.keys.map((key2) => page22.props[key2]),
      () => {
        const exists = this.keys.length > 0 && this.keys.every((key2) => page22.props[key2] !== void 0);
        this.loaded = exists;
